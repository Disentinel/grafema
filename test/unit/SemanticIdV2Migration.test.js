...
`;
    ...
    it('should produce v2 parseable IDs for FUNCTION nodes generated by FunctionVisitor', async () => {
...
`;
    ...
    it('should produce v2 parseable IDs for class methods generated by ClassVisitor', async () => {
