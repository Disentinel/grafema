...
> **v0.4.0** — Early access. [Changelog](./CHANGELOG.md) | [Known limitations](./KNOWN_LIMITATIONS.md)
...
40+ MCP tools available: `find_nodes`, `find_calls`, `trace_dataflow`, `get_file_overview`, `describe`, `query_graph`, and more. The AI agent queries the graph instead of reading files — faster, cheaper, more complete.
...
- **MCP Server** — 40+ tools for AI agent integration (find_nodes, find_calls, trace_dataflow, describe, query_graph, etc.)
