...
- run: `rofl-conformance-1787534870048` (identity in `conformance-run-meta.json`; the machine report `conformance-report.json` is byte-reproducible and carries no run identity)
- oracle: ROFL v0 vendored at `052a4c5` (main); subject: rfdb-server 0.4.1 (protocol v3, derive engine, repo `78c0a74d0b76`, binary sha256 `9c1aedef8ed2`)
