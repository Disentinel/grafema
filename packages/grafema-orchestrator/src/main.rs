...
fn pack_owned_slice(pack: &str) -> &'static str {
    match pack {
        ...
        "@stdlib/js_builtins_nodes" => "node-builtin + external-dep EXTERNAL_MODULE / EXTERNAL_FUNCTION nodes",
        "@stdlib/js_builtins_edges" => "node-builtin + external-dep IMPORTS_FROM + CALLS",
