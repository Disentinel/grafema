        ...
        classPath.traverse({
          ClassProperty: (propPath: NodePath) => {
            ...
            if (propNode.value &&
              ...
              if (parameters) {
                createParameterNodes(funcNode.params, functionId, module.file, propLine, parameters as ParameterInfo[]);
              }
          ...
          ClassMethod: (methodPath: NodePath<ClassMethod>) => {
            ...
            if (parameters) {
              createParameterNodes(methodNode.params, functionId, module.file, methodLine, parameters as ParameterInfo[]);
            }
